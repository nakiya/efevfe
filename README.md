...
* [`src/cljs/formula/`](src/cljs/formula/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/formula/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `formula` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/formula/config.cljs) defaults to `true` in
...
```clj
(ns formula.example
  (:require [formula.config :as config])
